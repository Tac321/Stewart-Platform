...
function [LegsSCD]=stewLegLog(fcn)
clc
% close all
 load smoothedMeanPosingManualTest.mat
% load pilotFlightDataWorkspace.mat
global grumx grumy grumz grumx2 grumy2 grumz2 neutralZ
neutralZ = 111;
grrrraahh = length(grumx)
if nargin == 0
    fcn = 'stew';
end
switch fcn
...
%         'Callback',[plotinfo.myname,' solve_for']);
    ...
    load_data()
    %----------------------draw intial plot
    initial_coords=[str2num(get(plotinfo.plat1x,'String')),str2num(get(plotinfo.plat1y,'String')),neutralZ-str2num(get(plotinfo.Pzval,'String')),...
                    str2num(get(plotinfo.plat2x,'String')),str2num(get(plotinfo.plat2y,'String')),neutralZ-str2num(get(plotinfo.Pzval,'String')),...
                    str2num(get(plotinfo.plat3x,'String')),str2num(get(plotinfo.plat3y,'String')),neutralZ-str2num(get(plotinfo.Pzval,'String')),...
                    str2num(get(plotinfo.plat4x,'String')),str2num(get(plotinfo.plat4y,'String')),neutralZ-str2num(get(plotinfo.Pzval,'String')),...
                    str2num(get(plotinfo.plat5x,'String')),str2num(get(plotinfo.plat5y,'String')),neutralZ-str2num(get(plotinfo.Pzval,'String')),...
                    str2num(get(plotinfo.plat6x,'String')),str2num(get(plotinfo.plat6y,'String')),neutralZ-str2num(get(plotinfo.Pzval,'String'))];
    draw_plat(initial_coords,neutralZ)
    view([-45,35])
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% End of the GUI creation section. SCD
...
case 'solve_inv'
    ...
    pause(1)
    LegsSCD=solve_inverse(neutralZ);
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    function draw_plat(plat_coords,neutralZ)
        cla
        hold on
        axis vis3d
        plotinfo=get(gcf,'UserData');
...
%                 plot3([0 0],[0 0],[0 111.31],'-ob','MarkerSize',3,'linewidth',line_size)
                  plot3([0 0],[0 0],[0 neutralZ],'-ob','MarkerSize',3,'linewidth',line_size) % paint our set neutral point
            %base
            ...
            %legs
                plotinfo.p1=plot3([a1(1) b1(1)],[a1(2) b1(2)],[a1(3) b1(3)],'-.r','MarkerSize',6,'linewidth',line_size,'EraseMode','none');
                plotinfo.p2=plot3([a2(1) b2(1)],[a2(2) b2(2)],[a2(3) b2(3)],'-y','MarkerSize',6,'linewidth',line_size);
                plotinfo.p3=plot3([a3(1) b3(1)],[a3(2) b3(2)],[a3(3) b3(3)],'-g','MarkerSize',6,'linewidth',line_size);
                plotinfo.p4=plot3([a4(1) b4(1)],[a4(2) b4(2)],[a4(3) b4(3)],'-b','MarkerSize',6,'linewidth',line_size);
                plotinfo.p5=plot3([a5(1) b5(1)],[a5(2) b5(2)],[a5(3) b5(3)],'-m','MarkerSize',6,'linewidth',line_size);
                plotinfo.p6=plot3([a6(1) b6(1)],[a6(2) b6(2)],[a6(3) b6(3)],'-c','MarkerSize',6,'linewidth',line_size);
            %platform
                plotinfo.p7=plot3([b1(1) b2(1)],[b1(2) b2(2)],[b1(3) b2(3)],'-k','MarkerSize',6,'linewidth',line_size);
                plotinfo.p8=plot3([b2(1) b3(1)],[b2(2) b3(2)],[b2(3) b3(3)],'-k','MarkerSize',6,'linewidth',line_size);
                plotinfo.p9=plot3([b3(1) b4(1)],[b3(2) b4(2)],[b3(3) b4(3)],'-k','MarkerSize',6,'linewidth',line_size);
                plotinfo.p10=plot3([b4(1) b5(1)],[b4(2) b5(2)],[b4(3) b5(3)],'-k','MarkerSize',6,'linewidth',line_size);
                plotinfo.p11=plot3([b5(1) b6(1)],[b5(2) b6(2)],[b5(3) b6(3)],'-k','MarkerSize',6,'linewidth',line_size);
                plotinfo.p12=plot3([b6(1) b1(1)],[b6(2) b1(2)],[b6(3) b1(3)],'-k','MarkerSize',6,'linewidth',line_size);
            rotate3d
            set(gcf,'UserData',plotinfo)
...
%             end
    ...
    function [LegsSCD]=solve_inverse(neutralZ)
            plotinfo=get(gcf,'UserData');
            xsi=[str2num(get(plotinfo.base1x,'String')),...
                 str2num(get(plotinfo.base2x,'String')),...
                 str2num(get(plotinfo.base3x,'String')),...
            ...
            ymi=[str2num(get(plotinfo.plat1y,'String')),...
             ...
             [inverse_solution,LegsSCD]=stew_inverse(xsi,ysi,xmi,ymi,roll,pitch,yaw,px,py,pz,neutralZ);
             LegsSCD;
             ...
             if anim_state==0
                draw_plat(plat_coords,neutralZ)
             elseif anim_state==1
